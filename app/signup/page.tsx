...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const redirect = () => router.push(`/otp_verify?${params.toString()}`)
      if (message) {
      ...
      <div className="flex items-center justify-center px-4 py-10 sm:py-16">
        <div className="w-full max-w-lg rounded-2xl border px-8 py-10 sm:px-12 sm:py-12" style={{ borderColor: '#D6D1C4', backgroundColor: '#FDFBF0' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-sm font-medium mb-1.5" style={{ color: '#054742' }}>
                Full Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium mb-1.5" style={{ color: '#054742' }}>
                Confirm Password
              </label>
              <div className="relative">
                <input
            ...
            {error && (
              <p className="text-center text-xs" style={{ color: '#C75050' }}>
                {error}
              </p>
            )}
            ...
            {successMessage && (
              <p
                className="text-center text-xs leading-relaxed rounded-lg px-3 py-2.5"
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs" style={{ color: '#9B9B9B' }}>Or sign up with</span>
            <div className="flex-1 h-px" style={{ backgroundColor: '#D6D1C4' }} />
          </div>
